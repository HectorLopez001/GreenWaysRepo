...
class PagComercioMapa extends Component {
  ...
  async componentDidMount() {
    ...
    return fetch("https://thegreenways.es/pagComercio.php", {
      ...
      .then(responseJson => {
        ...
        return fetch("https://thegreenways.es/listaFeedbacksComercio.php", {
          method: "POST",
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json"
        ...
        <View style={styles.MainContainer}>
          ...
          >
            ...
            >
              ...
              >
                <Text style={styles.textoBotones}>{"VOLVER AL MAPA"}</Text>
              </View>
            </TouchableOpacity>
          </View>
        </View>
