...
class ComerciosDetalle extends Component {
  ...
  GetItem(nombreComercio) {
    ...
    AsyncStorage.setItem("sceneComerciosAnterior", "listaComerciosDetalle");
    Actions.PagComercio();
  }
        ...
        <View style={styles.MainContainer}>
                  ...
                  >
                    <View style={styles.container}>
                      ...
                      <ImageLoad
                        ...
                        source={{
                          uri:
                            "https://thegreenways.es/" + rowData.imagenComercio
                        }}
                        resizeMethod={"resize"}
          ...
          <View style={styles.lineaBotones}>
            ...
            >
              <TouchableOpacity
                onPress={() => {
                  this.props.goComercios(this.state.datas);
                }}
              >
                <View
                  style={{
...
const mapDispatchToProps = dispatch => {
  return {
    goComercios: (comercios) => dispatch(MainActions.goComercios(comercios)),
