...
import ModificarActions from "./../actions/Modificar";
...
class Modificar extends Component {
  ...
  async componentDidMount() {
    ...
    await AsyncStorage.getItem("filaInicioCatalogoVendedor").then(value =>
      this.setState({ filaInicio: value })
    );
        ...
        return (
          <View style={styles.container}>
            <ScrollView ref="scroll" keyboardShouldPersistTaps="always">
              ...
              <View style={{ flexDirection: "row" }}>
                ...
                <View style={{ width: "74%" }}>
                  <TextInput
                    ...
                    placeholder={
                      "Descripcion del producto [Max. 60 caracteres]"
                    }
                    placeholderTextColor={"grey"}
                    returnKeyType={"next"}
                    autoCapitalize={"none"}
              ...
              <View style={{ flexDirection: "row" }}>
                <View style={{ width: "26%" }}>
                  <Text style={styles.tinyblack}>Precio:</Text>
                </View>
                <View style={{ width: "74%" }}>
                  <TextInput
                    ref={c => {
                    ...
                    placeholder={"Precio del producto ( Ej: 3,95 )"}
                    placeholderTextColor={"grey"}
                    returnKeyType={"next"}
                    autoCapitalize={"none"}
                    underlineColorAndroid={
              ...
              <View style={styles.container2}>
                <Text style={styles.bigblack2}>
                  Introduzca una nueva imagen del producto
                </Text>
...
const mapStateToProps = state => {
  return {
    hasError: state.modificar.hasError,
    isLoading: state.modificar.isLoading,
    campoError: state.modificar.campoError
  };
};
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    noErrores: () => dispatch(ModificarActions.noErrores()),
