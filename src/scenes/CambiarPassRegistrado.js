...
import CambiarPassRegistradoActions from "./../actions/CambiarPassRegistrado";
import Loader from "./../components/Loader";

class CambiarPassRegistrado extends Component {
...
const mapStateToProps = state => {
  return {
    hasError: state.cambiarPassRegistrado.hasError,
    isLoading: state.cambiarPassRegistrado.isLoading,
    campoError: state.cambiarPassRegistrado.campoError
  };
};
...
const mapDispatchToProps = dispatch => {
  return {
    modificarPass: (nombreLogeo, passUsuario, passNueva, passNueva2) =>
      dispatch(
        CambiarPassRegistradoActions.cambiarPassRegistrado(
          nombreLogeo,
          passUsuario,
          passNueva,
          passNueva2
    ...
    noErrores: () => dispatch(CambiarPassRegistradoActions.noErrores())
  };
};
