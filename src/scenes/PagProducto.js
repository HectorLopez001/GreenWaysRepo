...
class PagProducto extends Component {
      ...
      return (
        <View style={styles.MainContainer}>
          ...
          >
            <TouchableOpacity
              onPress={() => {
                if (this.state.sceneCatalogoAnterior == "fast") {
                  Actions.popTo("CatalogoClientesFast");
                } else {
                  if (this.state.sceneCatalogoAnterior == "noFast") {
                    Actions.popTo("CatalogoClientes");
                  }
                }
              }}
            >
              ...
              >
                <Text style={styles.textoBotones}>{"VOLVER AL CATÁLOGO"}</Text>
              </View>
            </TouchableOpacity>
          </View>
        </View>
